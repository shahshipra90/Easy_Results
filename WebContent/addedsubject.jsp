...
<title>Recent Subject Details</title>
...
<%
   String dept,sem, sub1, sub2, sub3, sub4, sub5, sub6, sub7, c1,c2,c3,c4,c5,c6,c7,p1,p2,p3,p4,p5, p6,p7,t1,t2,t3,t4,t5,t6,t7 = "null";
  %>
<%
                   	...
                   	Connection conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/er","root", "");
                   	 ...
                   	 Statement psmnt = conn.createStatement();
                  		 ...
                  		 System.out.println(sem);
                   			 ResultSet rs;
                                rs = psmnt.executeQuery("SELECT * from subject where department='"+dept+"'");
...
<jsp:include page="navigation.jsp"/>
	<div class="title">
       Recent Added subject Details<hr>
     </div>
     <br /><br /><br />
       ...
       <table class = "dept">
         ...
         <table class = "subject">
           ...
           <tbody>
            ...
            <tr class="none">
              <td colspan = "6" >
               <a href = "addsubject.jsp"><center><input type = "button" value = "Add new Subject" name = "submit" id = "submit" class= "subbtn"/></center></a>
              </td>
            </tr>
           </tbody>
         </table>
