        ...
        <table class = "dept">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <input type = "text" id = "sub1" name = "sub1" required/>
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm1" name = "pm1"  required oninput="add_number1()"/>
              </td>
              <td>
                <input type = "text" id = "tm1" name = "tm1"  required oninput="add_number1()"/>
              </td>
              <td><input type = "text" id = "st1" class = "smallbox" name = "st1" value = "" required onclick="subtotal()" /></td>
				<script>
            ...
            <tr>
              ...
              <td>
                <input type = "text" id = "sub2" name = "sub2"  required/>
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm2" name = "pm2"  required oninput="add_number2()"/>
              </td>
              <td>
                <input type = "text" id = "tm2" name = "tm2"  required oninput="add_number2()"/>
              </td>
              <td><input type = "text" id = "st2" class = "smallbox" name = "st2" value = "" required  onclick="subtotal()"/></td>
				<script>
            ...
            <tr>
              ...
              <td>
                <input type = "text" id = "sub3" name = "sub3"  required/>
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm3" name = "pm3" required oninput="add_number3()"/>
              </td>
              <td>
                <input type = "text" id = "tm3" name = "tm3" required oninput="add_number3()"/>
              </td>
              <td><input type = "text" id = "st3" class = "smallbox" name = "st3" value = "" required  onclick="subtotal()"/></td>
				<script>
						var text1 = document.getElementById("pm1");
						var text2 = document.getElementById("tm1");
            ...
            <tr>
              ...
              <td>
                <input type = "text" id = "sub4" name = "sub4"  required/>
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm4" name = "pm4" required oninput="add_number4()"/>
              </td>
              <td>
                <input type = "text" id = "tm4" name = "tm4" required oninput="add_number4()"/>
              </td>
              <td><input type = "text" id = "st4" class = "smallbox" name = "st4" value = "" required  onclick="subtotal()"/></td>
				<script>
            ...
            <tr>
              ...
              <td>
                <input type = "text" id = "sub5" name = "sub5" required />
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm5" name = "pm5" required oninput="add_number5()"/>
              </td>
              <td>
                <input type = "text" id = "tm5" name = "tm5" required oninput="add_number5()"/>
              </td>
              <td><input type = "text" id = "st5" class = "smallbox" name = "st5" value = "" required  onclick="subtotal()"/></td>
				<script>
            ...
            <tr>
              ...
              <td>
                <input type = "text" id = "sub6" name = "sub6" required />
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm6" name = "pm6" required oninput="add_number6()"/>
              </td>
              <td>
                <input type = "text" id = "tm6" name = "tm6" required oninput="add_number6()"/>
              </td>
              <td><input type = "text" id = "st6" class = "smallbox" name = "st6" value = "" required  onclick="subtotal()"/></td>
				<script>
            ...
            <tr>
              ...
              <td>
                <input type = "text" id = "sub7" name = "sub7" required/>
              </td>
              <td>
                Code
              </td>
              ...
              <td>
                <input type = "text" class= "box" id = "pm7" name = "pm7" required oninput="add_number7()"/>
              </td>
              <td>
                <input type = "text" id = "tm7" name = "tm7" required oninput="add_number7()"/>
              </td>
              <td><input type = "text" id = "st7" class = "smallbox" name = "st7" value = "" required onclick="subtotal()"/></td>
				<script>
            ...
            <tr>
            	<td colspan="7" >
							<input type = "text" name = "total" id = "total" required style="margin-left:820px;"  placeholder = "Click here to get Total" value= "" onclick="subtotal()">
				</td>
		    </tr>
